...
import com.c3.jbz.R;
import com.c3.jbz.fragment.LogisticsFragment.OnListFragmentInteractionListener;
...
public class LogisticsRecyclerViewAdapter extends RecyclerView.Adapter<LogisticsRecyclerViewAdapter.ViewHolder> {
    ...
    public LogisticsRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
